...
st.write("Wgraj nagranie lub nagraj głos i rozpocznij analizę.")

st.subheader("Instrukcja nagrania")
st.write("""
Przeczytaj tekst:

"Na stole stoi czerwone jabłko. Obok leży książka i okulary.
Dzień jest słoneczny, a dzieci bawią się na podwórku."
""")
...
if st.session_state.result is not None:
    ...
    st.write(f"Prawdopodobieństwo: {proba:.2f}")

    info = translate_feature(feature)
